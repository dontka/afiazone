<?php
$pageTitle = 'Edit - Invoice | Vuexy - Bootstrap Admin Template';
$vendorStyles = ['/assets/vendor/libs/flatpickr/flatpickr.css'];
$pageStyles = ['/assets/vendor/css/pages/app-invoice.css'];
$vendorScripts = [
...
$additionalScripts = [
    '/assets/js/offcanvas-add-payment.js',
    '/assets/js/offcanvas-send-invoice.js',
    '/assets/js/app-invoice-edit.js',
];
ob_start();
?>
