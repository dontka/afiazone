<?php
$pageTitle = 'Product List - eCommerce | Vuexy - Bootstrap Admin Template';
$vendorStyles = ['/assets/vendor/libs/select2/select2.css'];
$vendorScripts = ['/assets/vendor/libs/select2/select2.js'];
$additionalScripts = ['/assets/js/app-ecommerce-product-list.js'];
ob_start();
?>
