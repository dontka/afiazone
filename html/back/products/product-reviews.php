<?php
$pageTitle = 'eCommerce Manage reviews - App | Vuexy - Bootstrap Admin Template';
$vendorStyles = [
    '/assets/vendor/libs/select2/select2.css',
    '/assets/vendor/libs/rateyo/rateyo.css',
];
$pageStyles = ['/assets/vendor/css/pages/app-ecommerce.css'];
$vendorScripts = [
    '/assets/vendor/libs/moment/moment.js',
    '/assets/vendor/libs/select2/select2.js',
    '/assets/vendor/libs/rateyo/rateyo.js',
];
$additionalScripts = [
    '/assets/js/app-ecommerce-reviews.js',
    '/assets/js/extended-ui-star-ratings.js',
];
ob_start();
?>
