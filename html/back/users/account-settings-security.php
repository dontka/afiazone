<?php
$pageTitle = 'Account settings - Security | Vuexy - Bootstrap Admin Template';
$vendorStyles = ['/assets/vendor/libs/select2/select2.css'];
$pageStyles = ['/assets/vendor/css/pages/page-account-settings.css'];
$vendorScripts = [
...
$additionalScripts = [
    '/assets/js/pages-account-settings-security.js',
