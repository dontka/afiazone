<?php
$pageTitle = 'Fleet - Logistics | Vuexy - Bootstrap Admin Template';
$vendorStyles = ['/assets/vendor/libs/mapbox-gl/mapbox-gl.css'];
$pageStyles = ['/assets/vendor/css/pages/app-logistics-fleet.css'];
$vendorScripts = ['/assets/vendor/libs/mapbox-gl/mapbox-gl.js'];
$additionalScripts = ['/assets/js/app-logistics-fleet.js'];
ob_start();
?>
