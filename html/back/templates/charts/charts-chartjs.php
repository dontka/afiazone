<?php
$pageTitle = 'Chart.js - Charts | Vuexy - Bootstrap Admin Template';
$vendorScripts = ['/assets/vendor/libs/chartjs/chartjs.js'];
$additionalScripts = ['/assets/js/charts-chartjs.js'];
ob_start();
?>
