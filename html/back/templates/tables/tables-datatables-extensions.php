<?php
$pageTitle = 'DataTables - Tables | Vuexy - Bootstrap Admin Template';
$vendorStyles = [
    '/assets/vendor/libs/datatables-select-bs5/select.bootstrap5.css',
    '/assets/vendor/libs/datatables-fixedcolumns-bs5/fixedcolumns.bootstrap5.css',
    '/assets/vendor/libs/datatables-fixedheader-bs5/fixedheader.bootstrap5.css',
];
$additionalScripts = ['/assets/js/tables-datatables-extensions.js'];
ob_start();
?>
