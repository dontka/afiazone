<?php
$pageTitle = 'Cards Advance- UI elements | Vuexy - Bootstrap Admin Template';
$pageStyles = ['/assets/vendor/css/pages/cards-advance.css'];
$vendorScripts = ['/assets/vendor/libs/swiper/swiper.js'];
$additionalScripts = ['/assets/js/cards-advance.js'];
ob_start();
?>
