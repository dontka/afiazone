<?php
$pageTitle = 'Cards Analytics- UI elements | Vuexy - Bootstrap Admin Template';
$pageStyles = ['/assets/vendor/css/pages/app-logistics-overview.css'];
$additionalScripts = ['/assets/js/cards-analytics.js'];
ob_start();
?>
