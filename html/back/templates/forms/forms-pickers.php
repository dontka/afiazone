<?php
$pageTitle = 'Pickers - Forms | Vuexy - Bootstrap Admin Template';
$vendorStyles = [
...
$vendorScripts = [
    ...
    '/assets/vendor/libs/jquery-timepicker/jquery-timepicker.js',
    '/assets/vendor/libs/pickr/pickr.js',
];
$additionalScripts = ['/assets/js/forms-pickers.js'];
ob_start();
?>
