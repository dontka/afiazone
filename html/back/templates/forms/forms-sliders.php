<?php
$pageTitle = 'Sliders - Forms | Vuexy - Bootstrap Admin Template';
$vendorStyles = ['/assets/vendor/libs/nouislider/nouislider.css'];
$vendorScripts = ['/assets/vendor/libs/nouislider/nouislider.js'];
$additionalScripts = ['/assets/js/forms-sliders.js'];
ob_start();
?>
              <h4 class="py-3 mb-4">
