<?php
$pageTitle = 'Modals - UI elements | Vuexy - Bootstrap Admin Template';
$vendorStyles = [
...
$additionalScripts = [
    ...
    '/assets/js/modal-enable-otp.js',
    '/assets/js/modal-share-project.js',
    '/assets/js/modal-create-app.js',
    '/assets/js/modal-two-factor-auth.js',
];
ob_start();
?>
