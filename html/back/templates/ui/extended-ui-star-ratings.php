<?php
$pageTitle = 'Star Ratings - Extended UI | Vuexy - Bootstrap Admin Template';
$vendorStyles = ['/assets/vendor/libs/rateyo/rateyo.css'];
$vendorScripts = ['/assets/vendor/libs/rateyo/rateyo.js'];
$additionalScripts = ['/assets/js/extended-ui-star-ratings.js'];
ob_start();
?>
