<?php
$pageTitle = 'BlockUI - Extended UI | Vuexy - Bootstrap Admin Template';
$vendorStyles = ['/assets/vendor/libs/spinkit/spinkit.css'];
$vendorScripts = ['/assets/vendor/libs/block-ui/block-ui.js'];
$additionalScripts = ['/assets/js/extended-ui-blockui.js'];
ob_start();
?>
