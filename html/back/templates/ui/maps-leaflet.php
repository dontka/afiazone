<?php
$pageTitle = 'Leaflet - Maps | Vuexy - Bootstrap Admin Template';
$vendorStyles = ['/assets/vendor/libs/leaflet/leaflet.css'];
$vendorScripts = ['/assets/vendor/libs/leaflet/leaflet.js'];
$additionalScripts = ['/assets/js/maps-leaflet.js'];
ob_start();
?>
