<?php
$pageTitle = 'Miscellaneous - Extended UI | Vuexy - Bootstrap Admin Template';
$vendorStyles = [
    '/assets/vendor/libs/toastr/toastr.css',
    '/assets/vendor/libs/animate-css/animate.css',
];
$vendorScripts = [
    '/assets/vendor/libs/clipboard/clipboard.js',
    '/assets/vendor/libs/moment/moment.js',
    '/assets/vendor/libs/idletimer/idletimer.js',
    '/assets/vendor/libs/numeral/numeral.js',
    '/assets/vendor/libs/toastr/toastr.js',
];
$additionalScripts = [
    '/assets/js/extended-ui-misc-clipboardjs.js',
    '/assets/js/extended-ui-misc-idle-timer.js',
    '/assets/js/extended-ui-misc-numeraljs.js',
];
ob_start();
?>
