<?php
$pageTitle = 'Fullscreen Timeline - Extended UI | Vuexy - Bootstrap Admin Template';
$vendorStyles = ['/assets/vendor/libs/animate-on-scroll/animate-on-scroll.css'];
$vendorScripts = ['/assets/vendor/libs/animate-on-scroll/animate-on-scroll.js'];
$additionalScripts = ['/assets/js/extended-ui-timeline.js'];
ob_start();
?>
