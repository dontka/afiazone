<?php
$pageTitle = 'Treeview - Extended UI | Vuexy - Bootstrap Admin Template';
$vendorStyles = ['/assets/vendor/libs/jstree/jstree.css'];
$vendorScripts = ['/assets/vendor/libs/jstree/jstree.js'];
$additionalScripts = ['/assets/js/extended-ui-treeview.js'];
ob_start();
?>
