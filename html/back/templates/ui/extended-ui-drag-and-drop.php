<?php
$pageTitle = 'Drag and Drop - Extended UI | Vuexy - Bootstrap Admin Template';
$vendorScripts = ['/assets/vendor/libs/sortablejs/sortable.js'];
$additionalScripts = ['/assets/js/extended-ui-drag-and-drop.js'];
ob_start();
?>
