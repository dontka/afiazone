<?php
$pageTitle = 'SweetAlert2 - Extended UI | Vuexy - Bootstrap Admin Template';
$vendorStyles = [
    '/assets/vendor/libs/animate-css/animate.css',
    '/assets/vendor/libs/sweetalert2/sweetalert2.css',
];
$vendorScripts = ['/assets/vendor/libs/sweetalert2/sweetalert2.js'];
$additionalScripts = ['/assets/js/extended-ui-sweetalert2.js'];
ob_start();
?>
