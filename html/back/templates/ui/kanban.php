<?php
$pageTitle = 'Kanban - Apps | Vuexy - Bootstrap Admin Template';
$vendorStyles = [
    '/assets/vendor/libs/jkanban/jkanban.css',
...
$pageStyles = ['/assets/vendor/css/pages/app-kanban.css'];
$vendorScripts = [
...
$additionalScripts = ['/assets/js/app-kanban.js'];
ob_start();
?>
