<?php
$pageTitle = 'Chat - Apps | Vuexy - Bootstrap Admin Template';
$vendorStyles = ['/assets/vendor/libs/bootstrap-maxlength/bootstrap-maxlength.css'];
$pageStyles = ['/assets/vendor/css/pages/app-chat.css'];
$vendorScripts = ['/assets/vendor/libs/bootstrap-maxlength/bootstrap-maxlength.js'];
$additionalScripts = ['/assets/js/app-chat.js'];
ob_start();
?>
