<?php
$pageTitle = 'My Courses - Academy | Vuexy - Bootstrap Admin Template';
$vendorStyles = [
    '/assets/vendor/libs/select2/select2.css',
    '/assets/vendor/libs/plyr/plyr.css',
];
$pageStyles = ['/assets/vendor/css/pages/app-academy.css'];
$vendorScripts = [
    '/assets/vendor/libs/select2/select2.js',
    '/assets/vendor/libs/plyr/plyr.js',
];
$additionalScripts = ['/assets/js/app-academy-course.js'];
ob_start();
?>
