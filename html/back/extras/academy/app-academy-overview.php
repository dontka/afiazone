<?php
$pageTitle = 'Academy - Overview - App | Vuexy - Bootstrap Admin Template';
$vendorScripts = ['/assets/vendor/libs/moment/moment.js'];
$additionalScripts = ['/assets/js/app-academy-overview.js'];
ob_start();
?>
              <!-- Hour chart  -->
