<?php
$pageTitle = 'Academy - My Courses - App | Vuexy - Bootstrap Admin Template';
$vendorStyles = ['/assets/vendor/libs/plyr/plyr.css'];
$pageStyles = ['/assets/vendor/css/pages/app-academy-details.css'];
$vendorScripts = ['/assets/vendor/libs/plyr/plyr.js'];
$additionalScripts = ['/assets/js/app-academy-course-details.js'];
ob_start();
?>
