<?php
$pageTitle = 'Carousel - UI elements | Vuexy - Bootstrap Admin Template';
$pageStyles = ['/assets/vendor/css/pages/ui-carousel.css'];
$vendorScripts = ['/assets/vendor/libs/swiper/swiper.js'];
$additionalScripts = ['/assets/js/ui-carousel.js'];
ob_start();
?>
