<?php
$pageTitle = 'Détails du produit - AfiaZone';
ob_start();
?>
                                    ...
                                    <div class="details-product-area">
                                        <div class="product-thumb-area">
                                            ...
                                            <div class="thumb-wrapper one filterd-items figure">
                                                <div class="product-thumb zoom" onmousemove="zoom(event)" style="background-image: url(/html/front/assets/images/shop/01.jpg)"><img src="/html/front/assets/images/shop/01.jpg" alt="product-thumb">
                                                </div>
                                            </div>
                                            <div class="thumb-wrapper two filterd-items hide">
                                                <div class="product-thumb zoom" onmousemove="zoom(event)" style="background-image: url(/html/front/assets/images/shop/02.jpg)"><img src="/html/front/assets/images/shop/02.jpg" alt="product-thumb">
                                                </div>
                                            </div>
                                            <div class="thumb-wrapper three filterd-items hide">
                                                <div class="product-thumb zoom" onmousemove="zoom(event)" style="background-image: url(/html/front/assets/images/shop/03.jpg)"><img src="/html/front/assets/images/shop/03.jpg" alt="product-thumb">
                                                </div>
                                            </div>
                                            <div class="thumb-wrapper four filterd-items hide">
                                                <div class="product-thumb zoom" onmousemove="zoom(event)" style="background-image: url(/html/front/assets/images/shop/04.jpg)"><img src="/html/front/assets/images/shop/04.jpg" alt="product-thumb">
                                                </div>
                                            </div>
                                            <div class="thumb-wrapper five filterd-items hide">
                                                <div class="product-thumb zoom" onmousemove="zoom(event)" style="background-image: url(/html/front/assets/images/shop/05.jpg)"><img src="/html/front/assets/images/shop/05.jpg" alt="product-thumb">
                                                </div>
                                            </div>
                                            <div class="product-thumb-filter-group">
                                                <div class="thumb-filter filter-btn active" data-show=".one"><img src="/html/front/assets/images/shop/01.jpg" alt="product-thumb-filter"></div>
                                                <div class="thumb-filter filter-btn" data-show=".two"><img src="/html/front/assets/images/shop/02.jpg" alt="product-thumb-filter"></div>
                                                <div class="thumb-filter filter-btn" data-show=".three"><img src="/html/front/assets/images/shop/03.jpg" alt="product-thumb-filter"></div>
                                                <div class="thumb-filter filter-btn" data-show=".four"><img src="/html/front/assets/images/shop/04.jpg" alt="product-thumb-filter"></div>
                                                <div class="thumb-filter filter-btn" data-show=".five"><img src="/html/front/assets/images/shop/05.jpg" alt="product-thumb-filter"></div>
                                            </div>
                                        </div>
                                        <div class="contents">
                                ...
                                <div class="tab-pane fade   show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                                    <div class="single-tab-content-shop-details">
                                        ...
                                        <div class="details-row-2">
                                            <div class="left-area">
                                                <img src="/html/front/assets/images/shop/06.jpg" alt="shop">
                                            </div>
                                            <div class="right">
                        ...
                        <div class="theiaStickySidebar">
                            <div class="shop-sight-sticky-sidevbar  mb--20">
                                ...
                                <div class="single-offer-area">
                                    <div class="icon">
                                        <img src="/html/front/assets/images/shop/01.svg" alt="icon">
                                    </div>
                                    <div class="details">
                                ...
                                <div class="single-offer-area">
                                    <div class="icon">
                                        <img src="/html/front/assets/images/shop/02.svg" alt="icon">
                                    </div>
                                    <div class="details">
                                ...
                                <div class="single-offer-area">
                                    <div class="icon">
                                        <img src="/html/front/assets/images/shop/03.svg" alt="icon">
                                    </div>
                                    <div class="details">
                            ...
                            <div class="our-payment-method">
                                ...
                                <img src="/html/front/assets/images/shop/03.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
